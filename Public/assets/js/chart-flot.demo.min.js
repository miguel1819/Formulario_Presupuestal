...
handleBasicChart=function() {
    ...
    for(var a=[], b=0;
    b<2*Math.PI;
    b+=.25)a.push([b, Math.sin(b)]);
    for(var c=[], d=0;
    d<2*Math.PI;
    d+=.25)c.push([d, Math.cos(d)]);
    for(var e=[], f=0;
    f<2*Math.PI;
    f+=.1)e.push([f, Math.tan(f)]);
    0!==$("#basic-chart").length&&$.plot($("#basic-chart"), [ {
        label: "data 1", data: a, color: purple, shadowSize: 0
    }
    , {
        label: "data 2", data: c, color: green, shadowSize: 0
    }
    , {
        label: "data 3", data: e, color: dark, shadowSize: 0
    }
    ], {
        series: {
            lines: {
...
handleStackedChart=function() {
    ...
    for(var a=[], b=0;
    b<=5;
    b+=1)a.push([b, parseInt(5*Math.random())]);
    for(var c=[], d=0;
    d<=5;
    d+=1)c.push([d, parseInt(5*Math.random()+5)]);
    for(var e=[], f=0;
    f<=5;
    f+=1)e.push([f, parseInt(5*Math.random()+5)]);
    for(var g=[], h=0;
    h<=5;
    h+=1)g.push([h, parseInt(5*Math.random()+5)]);
    for(var i=[], j=0;
    j<=5;
    j+=1)i.push([j, parseInt(5*Math.random()+5)]);
    for(var k=[], l=0;
    l<=5;
    l+=1)k.push([l, parseInt(5*Math.random()+5)]);
    var m=[[0,
    "Monday"],
    [1,
    "Tuesday"],
    ...
    n= {
        ...
        ,
        grid: {
            hoverable: !0, tickColor: "#ccc", borderWidth: 0, borderColor: "rgba(0,0,0,0.2)"
        }
        ,
        series: {
            stack:!0,
            ...
            ,
            bars: {
                show: !0, barWidth: .5, align: "center", fillColor: null
            }
            ,
        ...
        ,
        legend: {
            show: !0, labelBoxBorderColor: "#ccc", position: "ne", noColumns: 1
        }
    }
    ,
    o=[ {
...
handleTrackingChart=function() {
    ...
    function d() {
        ...
        if(!(a.x<b.xaxis.min||a.x>b.xaxis.max||a.y<b.yaxis.min||a.y>b.yaxis.max)) {
            ...
            ++c) {
                var j=i[c];
                for(d=0;
                d<j.data.length&&!(j.data[d][0]>a.x);
                ++d);
                var k,
                l=j.data[d-1],
                m=j.data[d];
    ...
    for(var a=[], b=[], c=0;
    c<14;
    c+=.1)a.push([c, Math.sin(c)]),
    b.push([c, Math.cos(c)]);
    if(0!==$("#tracking-chart").length) {
        var e=$.plot($("#tracking-chart"), [ {
            data: a, label: "Series1", color: dark, shadowSize: 0
        }
        , {
            data: b, label: "Series2", color: red, shadowSize: 0
        }
        ], {
            series: {
                lines: {
            ...
            , grid: {
                hoverable: !0, autoHighlight: !1, borderColor: "#ccc", borderWidth: 0
            }
            , xaxis: {
                tickLength: 0
            }
            ...
            , legend: {
                labelBoxBorderColor: "#ddd", backgroundOpacity: .4, color: "#fff", show: !0
            }
        }
        ),
...
handleBarChart=function() {
    ...
    if(0!==$("#bar-chart").length) {
        ...
        $.plot("#bar-chart", [ {
            ...
            series: {
                bars: {
                    show: !0, barWidth: .4, align: "center", fill: !0, fillColor: purple, zero: !0
                }
            }
            , xaxis: {
...
handleInteractivePieChart=function() {
    ...
    if(0!==$("#interactive-pie-chart").length) {
        for(var a=[], b=3, c=[purple, dark, grey], d=0;
        d<b;
        d++)a[d]= {
            label: "Series"+(d+1), data: Math.floor(100*Math.random())+1, color: c[d]
        }
        ;
...
handleDonutChart=function() {
    ...
    if(0!==$("#donut-chart").length) {
        for(var a=[], b=3, c=[dark, green, purple], d=["Unique Visitor", "Bounce Rate", "Total Page Views", "Avg Time On Site", "% New Visits"], e=[20, 14, 12, 31, 23], f=0;
        f<b;
        f++)a[f]= {
            label: d[f], data: e[f], color: c[f]
        }
        ;
        $.plot($("#donut-chart"), a, {
            series: {
...
handleInteractiveChart=function() {
    ...
    if(0!==$("#interactive-chart").length) {
        ...
        $.plot($("#interactive-chart"), [ {
            data:b, label:"Page Views", color:purple, lines: {
                show: !0, fill: !1, lineWidth: 2
            }
            , points: {
                show: !1, radius: 5, fillColor: "#fff"
            }
            , shadowSize:0
        }
        , {
            data:c, label:"Visitors", color:green, lines: {
                show: !0, fill: !1, lineWidth: 2, fillColor: ""
            }
            , points: {
                show: !1, radius: 3, fillColor: "#fff"
            }
            , shadowSize:0
        }
        ], {
            ...
            , grid: {
                hoverable: !0, clickable: !0, tickColor: "#ccc", borderWidth: 1, borderColor: "#ddd"
            }
            , legend: {
                labelBoxBorderColor: "#ddd", margin: 0, noColumns: 1, show: !0
            }
        }
        );
        var d=null;
        $("#interactive-chart").bind("plothover", function(b, c, e) {
            if($("#x").text(c.x.toFixed(2)), $("#y").text(c.y.toFixed(2)), e) {
                if(d!==e.dataIndex) {
                    ...
                    var f=e.datapoint[1].toFixed(2), g=e.series.label+" "+f;
                    a(e.pageX, e.pageY, g)
                }
            }
...
handleLiveUpdatedChart=function() {
    ...
    function b() {
        for(c.length>0&&(c=c.slice(1));
        c.length<d;
        ) {
            var a=c.length>0?c[c.length-1]: 50, b=Math.floor(Math.random() * (100 - 1)) + 1;;
            b<0&&(b=0),
            b>100&&(b=100),
            c.push(b)
        }
